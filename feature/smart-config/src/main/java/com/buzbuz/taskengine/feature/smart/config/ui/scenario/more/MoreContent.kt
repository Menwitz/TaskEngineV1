 ...
 */
package com.buzbuz.taskengine.feature.smart.config.ui.scenario.more
...
import com.buzbuz.taskengine.core.common.overlays.dialog.implementation.navbar.viewModels
...
import com.buzbuz.taskengine.feature.smart.config.databinding.ContentMoreBinding
import com.buzbuz.taskengine.feature.smart.config.di.ScenarioConfigViewModelsEntryPoint
import com.buzbuz.taskengine.feature.smart.debugging.ui.report.DebugReportDialog
...
class MoreContent(appContext: Context) : NavBarDialogContent(appContext) {
    ...
    private fun onTutorialClicked() {
        debounceUserInteraction {
            ...
            val intent = Intent()
                .setComponent(ComponentName(context.packageName, "com.buzbuz.taskengine.feature.tutorial.ui.TutorialActivity"))
